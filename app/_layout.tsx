        ...
        name='modal copy 2'
          options={{
            ...
            drawerIcon:(props: {
              color: string;
              size: number;
            })=><Ionicons name="albums" size={20}></Ionicons>,
            drawerLabelStyle:{marginLeft:-15}
          }
          }
        />
        ...
        name='modal copy 3'
          options={{
            ...
            drawerIcon:(props: {
              color: string;
              size: number;
            })=><Ionicons name="cellular" size={20}></Ionicons>,
            drawerLabelStyle:{marginLeft:-15}
          }
          }
        />
        ...
        options={{
          drawerLabel:"Varejo",
            ...
            drawerIcon:(props: {
              color: string;
              size: number;
            })=><Ionicons name="bag-add" size={20}></Ionicons>,
            drawerLabelStyle:{marginLeft:-15}
          }
          }
        />
        ...
        options={{
          drawerLabel:"Dermo",
            ...
            drawerIcon:(props: {
              color: string;
              size: number;
            })=><Ionicons name="pulse" size={20}></Ionicons>,
            drawerLabelStyle:{marginLeft:-15}
          }
          }
        />
        ...
        options={{
          drawerLabel:"Cmv",
            ...
            drawerIcon:(props: {
              color: string;
              size: number;
            })=><Ionicons name="shapes" size={20}></Ionicons>,
            drawerLabelStyle:{marginLeft:-15}
          }
          }
        />
